...
export const IQAPortal: React.FC = () => {
  ...
  const TabButton: React.FC<{tabId: IQATab; label: string}> = ({ tabId, label }) => (
     <button
    ...
    <div className="w-full max-w-6xl mx-auto">
      <div className="absolute top-4 right-4">
       ...
       <div className="bg-white p-8 rounded-2xl shadow-lg">
        <div className="mb-8">
            <h1 className="text-3xl font-bold text-slate-800 mb-2">IQA Portal</h1>
            <p className="text-slate-500">Internal Quality Assurance Dashboard</p>
        </div>
